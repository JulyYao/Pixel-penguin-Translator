...
$serverPidFile = Join-Path $launcherStateDir "localhost-server.pid"
...
[System.IO.File]::WriteAllText($serverPidFile, $serverProcess.Id.ToString(), [System.Text.UTF8Encoding]::new($false))
