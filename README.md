...
像素企鹅是一个轻量级的双语对话翻译工具，适合商务沟通、跨语言聊天和临时翻译记录管理。它以聊天界面组织翻译内容，每个项目对应一个双语对话记录。
...
- Android 构建产物
- 私有同步数据
- Codex / workspace 实验目录

## 许可证

暂未指定许可证。正式公开前建议补充 `LICENSE` 文件，例如 MIT License。